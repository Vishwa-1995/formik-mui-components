...
import React__default, { useContext, createContext, useEffect, useMemo, forwardRef, createElement, isValidElement, cloneElement, Children, useState, useCallback } from 'react';
...
var Form = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return createElement("form", _extends$1({
...
const AutoCompleteWrapper = ({ freeSolo, disabled, name, getOptions, customHandleChange, ...otherProps // Capture unknown props
    ...
    const fetchOptions = useCallback(debounce$1(async (query) => {
        setLoading(true);
        try {
...
function AutoCompleteSearchWrapper(props) {
    ...
    return (jsxRuntimeExports.jsx(Autocomplete, { sx: { mt: 1 }, isOptionEqualToValue: () => true, disabled: props.disabled, noOptionsText: "Search not found", options: props.useQueryResult.data ?? [], value: field.value, getOptionLabel: (option) => option.label, loading: props.useQueryResult.isFetching, onChange: (_, newValue) => setFieldValue(field.name, newValue), onInputChange: debounce$1((_, newInputValue) => {
            props.setInputValue(newInputValue === "" ? undefined : newInputValue.slice(0, 10).trim());
                        ...
                        ...params.InputProps,
                        endAdornment: jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: params.InputProps.endAdornment }),
                    } }), props.useQueryResult.isLoading && jsxRuntimeExports.jsx(LinearProgress, {})] })) }));
}
...
const AutoCompleteSearchMultipleWrapper = ({ name, label, useQueryResult, setInputValue, disabled, ...otherProps // Capture unknown props
    ...
    return (jsxRuntimeExports.jsx(Autocomplete, { multiple: true, limitTags: 2, freeSolo: false, clearOnBlur: false, disabled: disabled, disableCloseOnSelect: true, filterSelectedOptions: false, noOptionsText: "Search not found", options: useQueryResult.data ?? [], getOptionLabel: (option) => option?.label || option, loading: useQueryResult.isFetching, isOptionEqualToValue: (option, value) => {
        ...
        }, onInputChange: debounce$1((_, newInputValue, reason) => {
            if (reason === "input") {
        ...
        //   return options;
        // }}
        renderInput: (params) => (jsxRuntimeExports.jsx(TextField, { ...params, ...configTextField, label: label, placeholder: "Select Batches", 
            // onBlur={(e) => {
...
const CheckboxWrapper = ({ name, legend, customHandleChange = () => { }, ...otherProps }) => {
    ...
    return (jsxRuntimeExports.jsxs(FormControl, { children: [jsxRuntimeExports.jsx(FormGroup, { children: jsxRuntimeExports.jsxs(Stack, { direction: "row", children: [jsxRuntimeExports.jsx(FormControlLabel, { control: jsxRuntimeExports.jsx(Checkbox, { ...configCheckbox, checked: field.value }), label: "" }), jsxRuntimeExports.jsx(Box, { mt: 1.5, children: legend })] }) }), jsxRuntimeExports.jsx(FormHelperText, { ...configFormControl })] }));
};

export { AutoCompleteSearchMultipleWrapper, AutoCompleteSearchWrapper, AutoCompleteWrapper, CheckboxWrapper };
