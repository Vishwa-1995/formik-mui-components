...
var Form = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  return React.createElement("form", _extends$1({
...
function useAutocomplete(props) {
  ...
  const initialInputValue = React__namespace.useRef(getInputValue(defaultValue, multiple, getOptionLabel)).current;
...
const AutoCompleteWrapper = ({ freeSolo, disabled, name, getOptions, customHandleChange, ...otherProps // Capture unknown props
    ...
    const fetchOptions = React.useCallback(debounce$1(async (query) => {
        setLoading(true);
        try {
